...
class WADFeatureExtractor(object):
    ...
    def topological_features(self):
        ...
        start_location_px = self._find_thing_category('start')
        self.level['features']['start_location_x_px'] = int(start_location_px[0][0])
        self.level['features']['start_location_y_px'] = int(start_location_px[1][0])
